...
const Sidebar = ({ type }) => {
  ...
  return (
    <div className="sidebar flex flex-col space-y-4 h-screen relative divide-y  justify-center  rounded-[32px] px-[3rem] ">
      <div className="flex flex-col  items-start cursor-pointer ">
        <a
          className={
            "text-2xl text-left  capitalize  py-2  rounded block leading-loose duration-150 " +
            (option === "profile"
      ...
      <div className="flex flex-row  items-start cursor-pointer">
        <a
          className={
            "text-2xl  capitalize  py-2  block leading-loose duration-150 " +
            (option === "toDo"
              ? " text-white font-medium"
              : " text-neutral-400  font-normal")
          }
